  ...
  return (
    <div className="border border-spacing-96 p-8 bg-gray-100 rounded-md shadow-xl space-y-2">
      ...
      <div className="flex gap-3">
        <button className=" border border-1 border-blue-600 py-2 px-4 rounded-md bg-cyan-200">{job_time}</button>
        <button className=" border border-1 border-blue-600 py-2 px-4 rounded-md bg-cyan-200 ">{job_time2}</button>
      </div>
